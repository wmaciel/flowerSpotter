...
flickrAPIKey = "791ce1d658ff60520e5b2ea64a37734a"  # API key
flickrSecret = "d904b93ff4ce5ed9"  # shared "secret"
                        ...
                        if m:
                            for b in rsp.photos[0].photo:
                                if b is not None:
                                    ...
                                    out_file.write('interestingness: ' + str(current_image_num) + ' out of ' + str(
                                        total_images) + '\n');
                                    out_file.write('\n')
                                    current_image_num += 1
